...
3. [How do noisy outcomes affect mELO models](https://dclaz.github.io/mELO/articles/noise.html). An investigation in to 
how noise affects the accuracy of a mELO model.
