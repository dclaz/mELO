...
matches fails to improve these results. Let's fit a mELO model with $k=2$ which should
have more capacity to capture the non-transitive dynamics exhibited here.
